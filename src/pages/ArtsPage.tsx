  ...
  return (
    <div style={{ position: 'relative', zIndex: 2, background: '#050A0F' }}>
      ...
      <PageHero
        ...
        backgroundImage="/images/arts-music.webp"
        ...
        <div className="content-container">
          ...
          <div className="reveal-up" style={{ marginBottom: '80px' }}>
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '60px', alignItems: 'center' }} className="arts-grid">
              <img src="/images/arts-painting-instructor.webp" alt="Incarcerated women participating in painting and fine arts class with instructor" loading="lazy" style={{ width: '100%', aspectRatio: '16/10', objectFit: 'cover', borderRadius: '4px' }} />
              <div>
          ...
          <div className="reveal-up" style={{ marginBottom: '80px' }}>
            ...
            >
              ...
              <img src="/images/think-motion.webp" alt="Think Motion movement class" loading="lazy" style={{ width: '100%', aspectRatio: '16/10', objectFit: 'cover', borderRadius: '4px' }} />
            </div>
          </div>
          ...
          <div className="reveal-up" style={{ marginBottom: '80px' }}>
            ...
            >
              <img src="/images/arts-band-rehearsing.webp" alt="Incarcerated men music band rehearsing in correctional music room" loading="lazy" style={{ width: '100%', aspectRatio: '16/10', objectFit: 'cover', borderRadius: '4px' }} />
              <div>
                <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '20px' }}>
